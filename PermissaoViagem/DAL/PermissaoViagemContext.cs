...
namespace PermissaoViagem.DAL
{
    public class PermissaoViagemContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<PermissaoViagem.Models.Local> Locals { get; set; }
        ...
        public System.Data.Entity.DbSet<PermissaoViagem.Models.SolicitacaoViagem> SolicitacaoViagems { get; set; }
    }
}